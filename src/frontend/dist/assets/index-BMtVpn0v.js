  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-[#004085] dark:bg-gray-950 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-200 text-sm leading-relaxed", children: "India's Most Trusted Hub for Real Bikes & Scooters. Discover, compare, and get the best deals across India." }),
...
function VehicleCard({ vehicle, onViewDetail }) {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: "Buy Now on Official Site"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
    ...
    "main",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-8", children: [
          ...
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5", children: filtered.map((v2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `vehicles.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(VehicleCard, { vehicle: v2, onViewDetail: setDetailVehicle }) }, v2.id)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          VehicleDetailModal,
          {
...
function HomePage({ onNavigate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "bg-gray-50 dark:bg-gray-900 min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-5xl mx-auto px-4 py-6", "data-ocid": "home.section", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: featuredBikes.map((v2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `home.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(VehicleCard, { vehicle: v2, onViewDetail: setDetailVehicle }) }, v2.id)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: featuredScooters.map((v2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `home.item.${i + 4}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(VehicleCard, { vehicle: v2, onViewDetail: setDetailVehicle }) }, v2.id)) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-10 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 dark:text-gray-500 text-sm mt-3", children: "20 real vehicles — 10 Bikes & 10 Scooters" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      VehicleDetailModal,
      {
...
function AppShell() {
  ...
  const [lastAdminClick, setLastAdminClick] = reactExports.useState(0);
  const navigate = (p) => {
    setPage(p);
  ...
  const handleLogoSecretClick = (e) => {
    ...
    const now2 = Date.now();
    const newCount = now2 - lastAdminClick < 600 ? adminClickCount + 1 : 1;
    setAdminClickCount(newCount);
    setLastAdminClick(now2);
    if (newCount >= 3) {
      setPage("admin");
